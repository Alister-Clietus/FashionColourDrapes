...
@Component({
  selector: 'app-tone-selector-winter',
  templateUrl: './tone-selector-winter.component.html',
  styleUrls: ['./tone-selector-winter.component.css']
})
export class ToneSelectorWinterComponent implements OnInit {

...
@Component({
  selector: 'app-tone-selector-autumn',
  templateUrl: './tone-selector-autumn.component.html',
  styleUrls: ['./tone-selector-autumn.component.css']
})
export class ToneSelectorAutumnComponent implements OnInit {

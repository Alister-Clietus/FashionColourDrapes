...
@Component({
  selector: 'app-tone-selector-spring',
  templateUrl: './tone-selector-spring.component.html',
  styleUrls: ['./tone-selector-spring.component.css']
})
export class ToneSelectorSpringComponent implements OnInit {
